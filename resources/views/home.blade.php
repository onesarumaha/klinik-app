...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('fontend-utama/assets/img/favicon.png')}}" rel="icon">
  <link href="{{asset('fontend-utama/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{asset('fontend-utama/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{asset('fontend-utama/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{asset('fontend-utama/assets/vendor/aos/aos.css')}}" rel="stylesheet">
  <link href="{{asset('fontend-utama/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{asset('fontend-utama/assets/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
  <link href="{{asset('fontend-utama/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{asset('fontend-utama/assets/css/main.css')}}" rel="stylesheet">
...
<body class="index-page">
          ...
          <div class="col-lg-6">
            <div class="hero-visual" data-aos="fade-left" data-aos-delay="400">
              <div class="main-image">
                <img src="{{asset('fontend-utama/assets/img/health/staff-10.webp')}}" alt="Modern Healthcare Facility" class="img-fluid">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-visual">
              <div class="main-image">
                <img src="{{asset('fontend-utama/assets/img/health/facilities-9.webp')}}" alt="Modern medical facility" class="img-fluid">
              </div>
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="specialty-card">
              ...
              <div class="specialty-visual">
                <img src="{{asset('fontend-utama/assets/img/health/cardiology-1.webp')}}" alt="Cardiovascular Medicine" class="img-fluid">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="specialty-card">
              ...
              <div class="specialty-visual">
                <img src="{{asset('fontend-utama/assets/img/health/neurology-4.webp')}}" alt="Neurological Sciences" class="img-fluid">
                <div class="visual-overlay">
                  <i class="bi bi-cpu"></i>
                </div>
              </div>
          ...
          <div class="col-lg-8" data-aos="fade-right" data-aos-delay="200">
            <div class="featured-service-main">
              <div class="service-image-wrapper">
                <img src="{{asset('fontend-utama/assets/img/health/consultation-4.webp')}}" alt="Premier Healthcare Services" class="img-fluid" loading="lazy">
        ...
        <div class="specialties-grid" data-aos="fade-up" data-aos-delay="300">
          <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="{{asset('fontend-utama/assets/img/health/maternal-2.webp')}}" alt="Maternal Care" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
                  <h5>Maternal Care</h5>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="{{asset('fontend-utama/assets/img/health/vaccination-3.webp')}}" alt="Vaccination" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
                  <h5>Vaccination</h5>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="{{asset('fontend-utama/assets/img/health/emergency-1.webp')}}" alt="Emergency Care" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="specialty-card">
                <div class="specialty-image">
                  <img src="{{asset('fontend-utama/assets/img/health/facilities-6.webp')}}" alt="Advanced Tech" class="img-fluid" loading="lazy">
                </div>
                <div class="specialty-content">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="doctors-grid" data-aos="fade-up" data-aos-delay="300">
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="100">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-2.webp')}}" alt="Dr. Amanda Foster" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="200">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-6.webp')}}" alt="Dr. Marcus Johnson" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="300">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-4.webp')}}" alt="Dr. Rachel Williams" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="400">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-8.webp')}}" alt="Dr. David Chen" class="img-fluid">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="500">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-11.webp')}}" alt="Dr. Victoria Torres" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="doctor-profile" data-aos="zoom-in" data-aos-delay="600">
            <div class="profile-header">
              <div class="doctor-avatar">
                <img src="{{asset('fontend-utama/assets/img/health/staff-14.webp')}}" alt="Dr. Benjamin Lee" class="img-fluid">
                <div class="status-indicator available"></div>
              </div>
              <div class="doctor-details">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-6">
              <div class="image-container" data-aos="fade-left" data-aos-delay="300">
                <img src="{{asset('fontend-utama/assets/img/health/facilities-9.webp')}}" alt="Medical Excellence" class="img-fluid">
              </div>
            </div>
  ...
  <!-- Vendor JS Files -->
  <script src="{{asset('fontend-utama/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{asset('fontend-utama/assets/vendor/php-email-form/validate.js')}}"></script>
  <script src="{{asset('fontend-utama/assets/vendor/aos/aos.js')}}"></script>
  <script src="{{asset('fontend-utama/assets/vendor/glightbox/js/glightbox.min.js')}}"></script>
  <script src="{{asset('fontend-utama/assets/vendor/purecounter/purecounter_vanilla.js')}}"></script>
  <script src="{{asset('fontend-utama/assets/vendor/swiper/swiper-bundle.min.js')}}"></script>

  <!-- Main JS File -->
  <script src="{{asset('fontend-utama/assets/js/main.js')}}"></script>

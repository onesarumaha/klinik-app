...
@section('content')
                            ...
                            @foreach ($pasien as $p)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <!-- Modal Show -->
                                        <div class="modal fade" id="modalShow{{ $p->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalShowLabel{{ $p->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content text-left">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title font-weight-bold text-primary"
                                                            id="modalShowLabel{{ $p->id }}">Detail Pasien</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text" value="{{ $p->no_rekam_medis }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-2">
                                                            <label>NIK:</label>
                                                            <input type="text" value="{{ $p->nik }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-2">
                                                            <label>Nama:</label>
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text"
                                                                value="{{ $p->jk == 'L' ? 'Laki-laki' : 'Perempuan' }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-2">
                                                            <label>Tanggal Lahir:</label>
                                                            <input type="date" value="{{ $p->tanggal_lahir }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-2">
                                                            <label>No HP:</label>
                                                            <input type="text" value="{{ $p->no_hp }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                        <div class="mb-2">
                                                            <label>Alamat:</label>
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <input type="text" value="{{ $p->gol_darah }}"
                                                                class="form-control" readonly>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="modal fade" id="modalEdit{{ $p->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalEditLabel{{ $p->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content text-left">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title font-weight-bold text-primary"
                                                            id="modalEditLabel{{ $p->id }}">Edit Data Pasien</h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('data_pasien.update', $p->id) }}"
                                                            method="POST" class="editForm" novalidate>
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="mb-2">
                                                                <label>No Rekam Medis</label>
                                                                <input type="text" name="no_rekam_medis"
                                                                    class="form-control" value="{{ $p->no_rekam_medis }}"
                                                                    required>
                                                                <div class="invalid-feedback">No Rekam Medis wajib diisi.
                                                                </div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label>NIK</label>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <select name="jk" class="form-control" required>
                                                                    <option value="L"
                                                                        {{ $p->jk == 'L' ? 'selected' : '' }}>Laki-laki
                                                                    </option>
                                                                    <option value="P"
                                                                        {{ $p->jk == 'P' ? 'selected' : '' }}>Perempuan
                                                                    </option>
                                                                </select>
                                                            ...
                                                            <div class="mb-2">
                                                                ...
                                                                <input type="date" name="tanggal_lahir"
                                                                    ...
                                                                    required>
                                                                <div class="invalid-feedback">Tanggal lahir wajib diisi.
                                                                </div>
                                                            </div>
                                                            <div class="mb-2">
                                                                <label>No HP</label>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select name="gol_darah" class="form-control">
                                                                    <option value="A"
                                                                        {{ $p->gol_darah == 'A' ? 'selected' : '' }}>A
                                                                    </option>
                                                                    <option value="B"
                                                                        {{ $p->gol_darah == 'B' ? 'selected' : '' }}>B
                                                                    </option>
                                                                    <option value="AB"
                                                                        {{ $p->gol_darah == 'AB' ? 'selected' : '' }}>AB
                                                                    </option>
                                                                    <option value="O"
                                                                        {{ $p->gol_darah == 'O' ? 'selected' : '' }}>O
                                                                    </option>
                                                                </select>
                                                            </div>
                                                            <div class="modal-footer">
    ...
    <div class="modal fade" id="modalTambahPasien" tabindex="-1" role="dialog"
        aria-labelledby="modalTambahPasienLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title m-0 font-weight-bold text-primary" id="modalTambahPasienLabel">Tambah Data
                        Pasien
                    </h5>
